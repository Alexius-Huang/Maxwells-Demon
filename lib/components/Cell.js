...
import { changeCellType, changeCellContent, splitCell, mergeCell } from '../actions/CellActions'
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ changeCellContent, changeCellType, splitCell, mergeCell }, dispatch)
}
