    ...
    return (
      <nav id="top-navigation-bar">
        <div className="navigation-wrapper">
          ...
          <NavigationButton
            title="Save Notebook" iconName={ this.props.notebookSaving ? 'spinner' : "floppy-o" }
            clickEvent={() => this.props.saveNotebook()}
          />
        </div>
      </nav>
    )
...
function mapStateToProps({ StyleReducers, NavigationReducers, CellReducers }) {
  return { style: StyleReducers, NavigationReducers, notebookSaving: CellReducers.saving }
}
