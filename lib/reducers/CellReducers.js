  ...
  cells: [
    {
      ...
      dependentCellID: null, dependent: null, hide: false, showLangOption: false
    },
  ],
...
export const CellReducers = handleActions({
  ...
  SPLIT_CELL: (state, { payload: id }) => {
    ...
    result.cells.insert(i + 1, { id: counter, type, content: 'New Section', partial: 'half', dependentCellID: id, dependent: 'sub', hide: false, showLangOption: false })
    return result
  },
